 ...
 */
 ...
 const ProductInfo = ({listingID, title, price, description, category, condition, location, email, phone, images, active, flagged, banned}) => {
     ...
     /**
      * Toggles the flag button to flag or unflag the listing.
      */
      ...
      */
     const handleFlagClick = (listingDetails) => {
         toggleFlagButton();
             ...
             <div style={InfoBoxStyle}>
                 <div className="flex flex-col gap-2">
                     <h3 className="flex gap-1 font-semibold text-2xl">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style={{width:'1.75rem', height:'1.75rem'}} className="w-8 h-8">
