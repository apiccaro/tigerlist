...
import { getAnalytics } from "firebase/analytics"; //used to retrieve the Firebase Analytics instance associated with the site, not sure if this'll be necessary 
import { getAuth } from 'firebase/auth'; // lets us perform authentication-related operations
...
// actually gets the analytics 
//const analytics = getAnalytics(app); //PROBLEM LINE. IDK. ITS CAUSING EVERYTHING TO CRASH BUT THAT IS OKAY FOR NOW 
