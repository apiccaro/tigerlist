...
export async function PUT(request){
    ...
    test_title = "putListing"
    test_message = "Button pressed"
    const queryText = "INSERT INTO TestTable (title, text1) VALUES ('"+test_title+"', '"+test_message+"');"
...
"INSERT INTO TestTable (title, text1) VALUES ('"+test_title+"', '"+test_message+"');"